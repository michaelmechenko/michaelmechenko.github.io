...
<div class="align-center flex w-full flex-col justify-center sm:flex-row">
	<div class="">
		<div class="leading-none text-[0.5rem] text-1-text sm:text-[0.2rem] md:text-[0.3rem] lg:text-[0.5rem]">
			<pre>
 ...
 ##/ ###/ /##    ###     / ###  / ## / ###    / ###  /   / ###     ##        ##/ ###/ /##      / ###     / ###  / ## / ###    / ###    ###/ ####   ## / ###     / ###    
  ...
  ###  ###  ###   ###   ######/   ##     ##  ####/ ##   ######/    ### /      ###  ###  ###   ######/   ######/   ##     ##  ######/    ###   ###  ##   ### /  ######    
   ###  ###  ###   ##/   #####     ##    ##   ###   ##   #####      ##/        ###  ###  ###   #####     #####     ##    ##   #####      ###   ###  ##   ##/    ####     
		...
		<div class="flex flex-row justify-center py-2 text-1-tertiary">
			<!-- <div class="text-1-text">~*-.,_,.-*~' ^ '*-,</div> -->
			<div class="flex px-1">
				<a
