...
<div class="flex flex-col">
	...
	<div class="flex w-full shrink-0 basis-full flex-col items-center justify-center gap-y-4 pt-4">
		<div class="flex w-full lg:w-10/12">
			<div
				class="3xl:mx-16 3xl:mx-16 mx-4 flex basis-full flex-row justify-center space-x-4 border-[2px] border-solid border-1-tertiary/60 bg-rose-pine-iris/[6%] py-2 text-[0.85rem] text-1-text transition ease-in-out hover:border-1-tertiary/80 md:mx-16 md:space-x-6 lg:mx-14 lg:space-x-6 xl:mx-16"
			>
				<div
					role="button"
					tabindex="0"
